...
interface TextFieldProps {
  ...
  onSave?: (id: string, valor: any) => void;
}

export function TextField({ campo, onSave }: TextFieldProps) {
  ...
  const baseClasses =
    "flex-1 px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-orange-500 focus:border-transparent bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100";
    ...
    switch (campo.tipo) {
      ...
      case "fecha":
        return (
          <input
            type="text"
            value={valor ? new Date(valor).toLocaleDateString() : "Sin valor"}
            readOnly
      ...
      case "fecha_hora":
        return (
          <input
            type="text"
            value={valor ? new Date(valor).toLocaleString() : "Sin valor"}
            readOnly
            className="flex-1 px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg bg-gray-50 dark:bg-gray-700 text-gray-900 dark:text-gray-100"
          />
        );
